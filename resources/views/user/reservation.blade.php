			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 col-xs-12">
					<div class="contact-block">
						<form id="contactForm" action="{{url('reservation')}}" method="POST">
							@csrf
								...
								<div class="col-md-6">
									...
									<div class="col-md-12">
										<div class="form-group">
											<input type="date" name="date" class="datepicker picker__input form-control" name="date" type="text" value="" equired data-error="Please enter Date">
